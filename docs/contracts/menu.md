...
tokens:
  ...
  - name: surface-variant
    usage: Contained list hover and focus, the same tone-step shift Button uses.
  - name: danger
...
composition_rules:
  ...
  - Contained list hover/focus state uses the same tone-step logic as Button hover, not a separate highlight convention.
prohibitions:
