...
- **Composition rules:** Not a toast — Notification is inline and persistent until dismissed or the condition changes. Toast is a Tier 2 component with its own timing contract.
